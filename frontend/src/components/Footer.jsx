...
// Brand paths from Simple Icons; lucide-react has no brand logos.
const socials = [
  {
    name: 'Snapchat',
    href: 'https://snapchat.com/t/nPljPUA9',
  ...
  {
    name: 'WhatsApp',
    href: 'https://chat.whatsapp.com/EE5E3okhrcFFkOWxwLRQjW',
  ...
  {
    name: 'TikTok',
    href: 'https://vt.tiktok.com/ZSbejdV9V/',
